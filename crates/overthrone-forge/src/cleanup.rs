...
pub fn assess_detection_risk(action: &ForgeAction) -> DetectionAssessment {
    match action {
        ...
        ForgeAction::EnhancedDiamond => DetectionAssessment {
            ...
            mitigations: vec!["Already the most stealthy elevated TGT technique".into()],
        },
        ForgeAction::SapphireTicket => DetectionAssessment {
            ...
            mitigations: vec!["Use a user who is already a DA for maximum stealth".into()],
        },
        ForgeAction::BronzeBit { .. } => DetectionAssessment {
            ...
            indicators: vec![
                ...
                DetectionIndicator {
                    ...
                    detail: "Delegation from a user who is 'sensitive and cannot be delegated'"
                        .into(),
                    severity: RiskLevel::High,
                },
            ],
